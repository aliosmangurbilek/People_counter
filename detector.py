...
def update_frame(image, people_indxs, class_ids, detected_boxes, conf_levels, colors, labels,
    ...
    # write number of people in bottom corner y coor: image.shape[0] - 20
    text = "Persons: {}".format(count_people)
    cv2.putText(image, text, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 0), 2)
